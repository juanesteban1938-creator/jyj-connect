          ...
          <div className="flex items-center">
            ...
            <div className="absolute -right-10 -top-10 opacity-20">
              <svg width="200" height="200" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.5 4H5.5C4.67 4 4 4.67 4 5.5V14.5C4 15.33 4.67 16 5.5 16H6V18C6 18.55 6.45 19 7 19H8C8.55 19 9 18.55 9 18V16H15V18C15 18.55 15.45 19 16 19H17C17.55 19 18 18.55 18 18V16H18.5C19.33 16 20 15.33 20 14.5V5.5C20 4.67 19.33 4 18.5 4ZM18 11H6V7H18V11Z" />
              </svg>
            </div>
          </div>
        </CardContent>
